...
foreach redis_bulk_cmd {
    set setnx rpush lpush rpushx lpushx rpushxafter lpushxafter lset lrem sadd srem sismember echo getset smove zadd zrem zscore zincrby append zrank zrevrank hget hdel hexists setex
} {
